...
measurement → ✅
Reproduce with `python -m benchmarks.dimensionality`, or as *Phase 1c* inside `python run_all.py`.
Figure: [`../figs/dimensionality.png`](../../results/figs/dimensionality.png).
