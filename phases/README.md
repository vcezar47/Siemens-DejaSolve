...
| 4 · Cloud/Docker + final measurements | ✅ gate met 20 Aug — `docker compose up` verified on a clean build; architecture mapped | [../docs/architecture.md](../docs/architecture.md) |
