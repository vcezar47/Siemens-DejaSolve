...
Separate file and separate results, like `surrogate.py` and `fold.py`: nothing
here touches `results.json` or the phase-1 summary hash.

    python wide_sweep.py
"""
...
def main() -> int:
    ...
    ap.add_argument("--out", type=Path, default=Path("wide_sweep_results.json"))
