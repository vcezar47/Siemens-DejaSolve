...
So the runs are now kept (`sweep.py` writes `archive/failures.jsonl`,
...
and `verifier.py` does not gain a rule that sounds sensible and does nothing.

    python failure_zone.py
"""
...
def main() -> int:
    ...
    ap.add_argument("--out", type=Path, default=Path("failure_zone_results.json"))
