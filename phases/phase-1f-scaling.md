...
**Built:** Tue 25 Aug 2026 · [`../manifold.py`](../manifold.py) ·
`python manifold.py --selftest` · `python manifold.py`
...
`manifold.py` generates an N-branch manifold rather than hand-writing one:
